...
class Customer extends BaseModel implements AuthenticatableContract, JWTSubject
{
	...
	protected $guarded = ['id', 'supplier_id', 'warehouse_id', 'opening_balance', 'opening_balance_type', 'credit_limit', 'credit_period', 'role_id', 'created_at', 'updated_at'];
	...
	public function supplier()
	{
		...
		// return User::where('id', $this->supplier_id)->first();
	}
}
